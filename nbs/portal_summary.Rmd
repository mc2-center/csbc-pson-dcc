...
```{r}
ct_counts_syntable <- update_synapse_table("syn21649281", theme_grants, syntab, syn)
```
...
```{r}
# ct_counts_syntable <- update_synapse_table("syn21649281", consortiumtheme_projs, syntab, syn)
```
...
```{r}
theme_counts_syntable <- update_synapse_table("syn21639584", theme_counts, syntab, syn)
```
...
```{r}
consortium_counts_syntable <- update_synapse_table("syn21641485", consortium_counts, syntab, syn)
```
